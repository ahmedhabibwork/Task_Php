...
{{--                    </li>--}}
                ...
                <ul class="dropdown-content" id="profile-dropdown">
                    <li><a class="grey-text text-darken-1" href="{{url('admin/user-profile')}}"><i class="material-icons">person_outline</i> Profile</a></li>
...
{{--                    <li><a class="grey-text text-darken-1" href="page-faq.html"><i class="material-icons">help_outline</i> Help</a></li>--}}
                    ...
                    <li><a class="grey-text text-darken-1" class="dropdown-item" href="{{url('admin/logout')}}"
                           onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="material-icons">keyboard_tab</i> Logout</a></li>

                    <form id="logout-form" action="{{url('admin/logout')}}" method="Get" class="d-none">
                    @csrf
                        <input type="hidden" name="_token" value="p09QS91UpV6jG4jeEi7fux5wIxQBUyrhFOvMvT5f"> </form>
                </ul>
            </div>
