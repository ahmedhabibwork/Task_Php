                ...
                <div class="container">
                    ...
                    <section class="invoice-list-wrapper section">
                        ...
                        <div class="responsive-table">
                            <table class="search-area table invoice-data-table white border-radius-4 pt-1">
                                <thead>
                                <tr>
                                ...
                                @if(isset($customers))
                                    @foreach($customers as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="app-invoice-view.html">{{$value->id}}</a>
                                            </td>
                                            <td><span class="invoice-amount">{{$value->name}}</span></td>
                                            <td><small>{{$value->email}}</small></td>
                                            <td><small>{{$value->phone_number}}</small></td>


                                            @if($value->status==1)
                                                <td><span class="chip green lighten-5">
                                          <span class="green-text">Enable</span>
                                                </span>
                                                </td>
                                            @else

                                                <td>
                                                    <span class="chip lighten-5 red red-text">Disable</span>
                                                </td>
                                            @endif
                                            <td>

                                                <a href="{{route('admin.customer_actions.edit',$value->id)}}"
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('admin.customers.destroy', $value->id) }}"
                                                      method="post"
                                                    ...
                                                    <div class="invoice-action">
                                                        ...
                                                        <button type="submit">
                                                            <a href="{{route('admin.customers.destroy',$value->id)}}"
                                                        ...
                                                        <a href="{{route('admin.customers.edit',$value->id)}}"
                                                           class="invoice-action-edit">
