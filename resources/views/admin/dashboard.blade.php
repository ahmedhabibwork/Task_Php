        ...
        <div class="col s12">
            <div class="container">
                <div class="section">
                    ...
                    @endphp
                    <h4 class="col s12">Hi {{$user_login->name}} <br></h4>
                    @php $get_role_name=\App\Models\Shop\Role::find($user_login->role_id);@endphp
                    <h5 class="col s12">Your email : : {{$user_login->email}}</h5>
                    <h5 class="col s12">Your role : : {{$get_role_name->name}}</h5>
