                    ...
                    <section class="invoice-list-wrapper section">
                        ...
                        <div class="responsive-table">
                            <table class="search-area table invoice-data-table white border-radius-4 pt-1">
                                ...
                                <tbody>
                                @if(isset($employee_customers))
                                    @foreach($employee_customers as $value)
                                        <tr>
                                            <td></td>
                                            ...
                                            @php
                                                $employee=\App\Models\User::find($value->employee_id);
                                             $customer=\App\Models\User::find($value->customer_id);

                                            @endphp
                                            <td><span class="invoice-amount">{{$customer->name}}</span></td>
                                            <td><small>Assign To</small></td>
