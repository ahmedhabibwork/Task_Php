                            ...
                            <table class="search-area table invoice-data-table white border-radius-4 pt-1">
                                ...
                                @foreach($actions as $value)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <form action="{{route('admin.actions.destroy', $value->id) }}"
                                                  method="post"
                                                ...
                                                <div class="invoice-action">
                                                    ...
                                                    <button  type="submit">
                                                        <a href="{{route('admin.actions.destroy',$value->id)}}" class="invoice-action-view mr-4">
                                                            <i class="material-icons">delete_forever</i>

                                                        </a>
                                                    </button>

                                                    <a href="{{route('admin.actions.edit',$value->id)}}" class="invoice-action-edit">
