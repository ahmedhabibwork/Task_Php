                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Employee</span></h5>
                                            ...
                                            <div class="col s12">
                                                ...
                                                <form class="login-row" method="post"
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input id="phone_number" type="text" @error('phone_number') is-invalid
                                                                   @enderror name="phone_number" required>
